...
using Attempt = std::function<LocalMetadata::RecognitionBatch(const QVector<QImage> &, const LocalMetadata::OcrOptions &, const LocalMetadata::Cancellation &, const LocalMetadata::Progress &)>;
LocalMetadata::RecognitionBatch recognize(const QVector<QImage> &images, const LocalMetadata::OcrOptions &options,
                                          const LocalMetadata::Cancellation &cancel, const LocalMetadata::Progress &progress, const Attempt &attempt);
